...
<!-- This model handles vehicle and classification adding -->
...
<?php
    ...
    function getSelectList($classifications) {
        ...
        foreach ($classifications as $classification) {
            $selectList .= "<option value='" . urlencode((int)$classification['classificationId']) . "' >$classification[classificationName]</a></li>";
        }
        $selectList .= '</select>';
